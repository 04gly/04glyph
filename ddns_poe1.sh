...
zone_identifier="0b3ebc6077b8f759e69642b31ef00aea"
record_name="ip2.nvtai.id.vn"
ttl="60"
proxy="false"
sitename=""
slackchannel=""
...
ip=$(curl --interface pppoe1 -s -4 https://cloudflare.com/cdn-cgi/trace | grep -E '^ip'); ret=$?
if [[ ! $ret == 0 ]]; then # In the case that cloudflare failed to return an ip.
    # Attempt to get the ip from other websites.
    ip=$(curl --interface pppoe1 -s https://api.ipify.org || curl --interface pppoe1 -s https://ipv4.icanhazip.com)
else
